...
const LetsBuild: React.FC = () => {
  return (
    <section className="py-24 flex flex-col lg:flex-row items-center gap-12">
      ...
      <div className="flex-1">
        <img src="/offline_images/conclusion-image.jpg" alt="Abstract design" className="w-full h-auto rounded-3xl object-cover" />
      </div>
    </section>
  );
};
